...
<html lang="zh-CN">
	...
	<body ontouchstart="" class="container">
		<section class="hot-goods-container row text-center">
			<header class="buy-buy-nav-bar col-xs-12">
				<span class="new-listed col-xs-4">新上市</span>
				<span class="active hot-goods col-xs-4" >抢手货</span>
				<span class="col-xs-4">限时购</span>
			</header>
			<div class="hot-goods-content col-xs-12">
				<div id="hot_goods_container">
					<div class="hot-goods-top hot-goods-top1 col-xs-12">
					...
					<div class="hot-goods-list col-xs-12 text-center">
						<div class="goods-left-item col-xs-6">
							<div class="hot-goods-item col-xs-12">
								...
								<span class="goods-intro-text col-xs-12">【现货】【明星款】果粉必备红色特别版 中.</span>
								<span class="goods-price-container col-xs-12">
	                                <span class="goods-price-new col-xs-5 col-xs-offset-1">
	                                		<span class="yen">￥</span>3455
								</span>
								<span class="goods-price-old col-xs-5">
	                                		<span class="yen">￥</span>4566
								</span>
								</span>
							</div>
							<div class="hot-goods-item col-xs-12">
						...
						<div class="goods-right-item col-xs-6">
							...
							<div class="hot-goods-item col-xs-12">
								<div class="goods-cover col-xs-8 col-xs-offset-2">
									<img src="image/buy_buy/EF79A4B2-6792-4068-82D7-1FA4E1E5ACE6.png" />
								</div>
								<span class="goods-title col-xs-12">Apple iphone 7</span>
								<span class="goods-intro-text col-xs-12">【现货】【明星款】果粉必备红色特别版 中.</span>
								<span class="goods-price-container col-xs-12">
		...
		<script type="text/javascript" src="js/buy_buy/hot_goods.js"></script>
	</body>
