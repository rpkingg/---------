...
<html lang="zh-CN">
	...
	<body ontouchstart="" class="container">
		<section class="time-buy-container row text-center">
			<header class="buy-buy-nav-bar col-xs-12">
				<span class="new-listed col-xs-4">新上市</span>
				<span class="hot-goods col-xs-4">抢手货</span>
				<span class="active time-buy col-xs-4">限时购</span>
			</header>
			<div class="time-buy-content col-xs-12" id="time_buy_container">
				<div class="time-buy-item col-xs-12">
					...
					<div class="time-buy-goods-info col-xs-12">
						<div class="goods-base-info col-xs-12">
							...
							<span class="goods-price col-xs-3 text-center"><span class="yuan">￥</span>5688</span>
						</div>
	...
	<script type="text/javascript" src="js/buy_buy/time_buy.js"></script>
</html>