...
<html lang="zh-CN">
	<head>
		...
		<link rel="stylesheet" href="css/my_user_side/collect_notes.css">
		<link rel="stylesheet" href="css/my_user_side/collect_goods.css">
		<link rel="stylesheet" href="css/my_user_side/collect_stores.css">
		...
		<section class="collect-notes-container row text-center">
			<header class="collect-list-nav-bar col-xs-12">
				<div class="collect-nav-bar col-xs-12">
					<span class="collect-notes active col-xs-4" id="note">笔记&nbsp;·&nbsp;<span id="node_num">0</span></span>
					<span class="col-xs-4" id="goods">商品&nbsp;·&nbsp;<sapn id="goods_num">0</sapn></span>
					<span class="col-xs-4" id="shop">店铺&nbsp;·&nbsp;<span id="shop_num">0</span></span>
				</div>
				<span class="break-line-bar col-xs-12"></span>
			</header>
			<!--收藏的笔记-->
			<div id="collection_note_container">
				<div class="collect-notes-content col-xs-12">
			...
			<div id="collection_goods_container" style="display: none;">
				<div class="collect-goods-content col-xs-12">
			...
			<div id="collection_shop_container" style="display: none;">
				<div class="collect-stores-content col-xs-12">
	...
	<script type="text/javascript" src="js/my_user_side/collect_notes.js"></script>
</html>