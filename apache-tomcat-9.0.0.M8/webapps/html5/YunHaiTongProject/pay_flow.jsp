				...
				<div class="goods_item">
					<div class="bottom_box">
						<div class="inquiry_header_div">
							<img src="img/pay_flow.png" class="pay_phone_img" />
						</div>
						<div class="pay_phone_text">充流量</div>
	...
	<script type="text/javascript">
		...
		$('.cancel-pay').on('click', function() {
			...
			if(payWay == aliPay) {
				...
				localStorageObj.setItem("order_pay_type","1");
