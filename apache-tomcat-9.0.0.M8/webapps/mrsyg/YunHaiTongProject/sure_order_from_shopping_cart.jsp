...
<html lang="zh-CN">
	...
	<body ontouchstart="" class="container">
			...
			<div class="pay-tool-info col-xs-12">
				...
				<div class="pay-select-info col-xs-12">
					<span class="pay-amount col-xs-12">金额：
                        <span id="pop_up_money">￥5688</span> （请在30分钟内完成支付）
					</span>
		...
		<!--跳转支付宝页面-->
		<div class="iframe_container" id="iframe_alipayment">
			<iframe id="iframe_alipayment_id" src="https://mclient.alipay.com/home/exterfaceAssign.htm?alipay_exterface_invoke_assign_client_ip=120.27.34.155&subject=%EF%BF%BD%EF%BF%BD%C6%B7&sign_type=RSA&notify_url=http%3A%2F%2F120.76.190.223%3A8988%2Fmrsyg%2Fkquser%2Fnotify.do&out_trade_no=0000016512&return_url=http%3A%2F%2F120.76.190.223%3A8988%2Fmrsyg%2Fmodule%2Falipaym%2Freturn_url.jsp&sign=tcNbn0HpiexIcF%2BcDMm4WErMbgzBplkWr95aN63I0%2F2RtWKmtLCPIZf8er8rFY5dD3Dl1DDoDi%2FGmumuUj0c%2BJRJeVYZas7iU70gw8NJOKvdAhQPhyWlejYfMId%2Bp348%2BRFA%2BK3OpGZKLyBkEwdhr%2FtvqOJCU3bu0OpRGm9Nqis%3D&_input_charset=utf-8&alipay_exterface_invoke_assign_target=mapi_direct_trade.htm&alipay_exterface_invoke_assign_model=cashier&total_fee=0.1&service=alipay.wap.create.direct.pay.by.user&partner=2088611380454587&seller_id=2088611380454587&alipay_exterface_invoke_assign_sign=_k_n9_nlc_fcb_g4_r_t_qb_hj_r_t_x_wxu_xv_u_r9_rf_b_sz_qh_l_n_w0y_y_o_x1s14_mtc_d_e_lw%3D%3D&payment_type=1&show_url=http%3A%2F%2F120.76.190.223%3A8988%2Fhtml5%2FYunHaiTongProject%2Fpay_success.html" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
		</div>
		<!--支付宝支付表单-->
	...
	<script type="text/javascript" src="js/find_goods/sure_order_from_shopping_cart.js"></script>
