		...
		<section class="look-detail-container row text-center">
			...
			<div class="look-item-base-info col-xs-12">
				...
				<div class="look-item-info col-xs-12">
					<span class="look-item-name col-xs-12 text-left">手机支付安全性考察测验米的手机过关么？</span>
					<div class="look-item-tip col-xs-12">
						<span class="view-count col-xs-3">
         					<span class="iconfont icon-eye-open"></span>
						<span id="page_view">32次</span>
						</span>
						<span class="col-xs-6 text-left" id="video_duration">时长：18:20</span>
					</div>
				</div>
				<div class="look-publish-user-container col-xs-12">
					...
					<div class="publish-content-info col-xs-12">
						<span id="action_content" class="publish-content col-xs-12 text-left">同样的像素为什么拍出来的照片不一样，手残当你可知 道你手机摄像头的秘密 最近看到国产手机宣传自己的摄像头时各种鼓吹“画质堪比单反相机”“单反级画质”但是作为摄影爱好者也知道手机的感光元件尺寸和单反根本没法比，那么问题来了，目前手机摄像头如索尼IMX214234的性能究竟能达到什么水准？厂商类似上述宣传用语是否涉嫌虚假宣传？ 是的，手机很强，诺基亚用的是蔡司认证，三星用的是施耐德认证，我给你两张片子你用肉眼看看能不能分辨出iphone6和5D3。</span>
					...
					<div class="swiper-container">
						<div class="swiper-wrapper overflow_x">
							<div class="swiper-slide text-center goods-item col-xs-3">
								...
								<span class="goods-name">魅族 note5金色 32g</span>
			...
			<div class="user-comments-container col-xs-12">
				...
				<div class="comment-content-container col-xs-12">
					<div class="comment-item col-xs-12">
						...
						<div class="comment-other-info col-xs-10 text-left">
							<span class="user-name col-xs-12">JOJO-溪溪</span>
							<span class="comment-cont col-xs-12">大家买手机比较来比较去其实吧都差不多，反正我感 觉用的习惯不就好了么！就好了么就好了么就好了么</span>
					...
					<div class="comment-item col-xs-12">
						...
						<div class="comment-other-info col-xs-10 text-left">
							<span class="user-name col-xs-12">我不是超人</span>
							<span class="comment-cont col-xs-12">大家买手机比较来比较去其实吧都差不多，反正我感 觉用的习惯不就好了么！</span>
							<div class="comment-tip-info col-xs-12">
								<div class="publish-time-jinbi col-xs-5">
									<span class="time-text">06-15 08:52</span>
									<span class="jinbi-info">
								...
								<div class="reply-list-container col-xs-12">
									<div class="reply-item col-xs-12">
										<div class="reply-main-info col-xs-12">
											<span class="reply-user-name">羊肉烤串: </span>
											<span class="user-reply-cont">楼上这位感觉说话不是很现实哈,货比 三家的心理谁都有吧，除非...</span>
										</div>
									...
									<!--默认显示一条-->
									<span class="view-other-replys col-xs-12">查看剩下3条回复</span>
					...
					<div class="comment-item col-xs-12">
						...
						<div class="comment-other-info col-xs-10 text-left">
							<span class="user-name col-xs-12">聪明的一休</span>
							<span class="comment-cont col-xs-12">吃瓜群众，纯属路过哈哈</span>
							<div class="comment-tip-info col-xs-12">
								<div class="publish-time-jinbi col-xs-5">
									<span class="time-text">06-15 08:52</span>
									<span class="jinbi-info">
				...
				<span class="view-all-reply col-xs-12">
    				<span>查看全部</span><span class="iconfont icon-jiantou-copy"></span>
				</span>
			</div>
			<div class="look-detail-opt-nar col-xs-12">
				...
				<div class="liao-liao-btn col-xs-4">
					...
					<span class="liao-liao-text">聊聊</span>
				</div>
			</div>
		</section>
		<!--打赏弹出框-->
			...
			<div class="give-reward-content col-xs-12">
				<div class="user-opt-dialog col-xs-9">
					...
					<div class="dialog-header col-xs-8 col-xs-offset-2">
						<span class="header-title col-xs-10">打赏</span>
					</div>
					<div class="dialog-content col-xs-12">
						<div class="input-group">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><span>文章写的太好了，赞一个！</span></li>
								<li><span>内容非常有指导意义！</span></li>
								<li><span>自定义评语</span></li>
							</ul>
						</div>
						...
						<div class="give-shang col-xs-12">
							<span class="col-xs-8 col-xs-offset-2">打赏</span>
						</div>
						<span class="yunbi-tip-count col-xs-10">你剩余云币数量: <span class="total-yunbi">15</span></span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="plus-liao-liao-container text-center hide">
			<div class="plus-liao-liao-content col-xs-12">
				<div class="user-opt-dialog col-xs-9">
					...
					<div class="dialog-header col-xs-8 col-xs-offset-2">
						<span class="header-title col-xs-10">加聊聊</span>
					</div>
					<div class="dialog-content col-xs-12">
						<div class="liao-liao-user-info col-xs-12">
							...
							<span class="user-name col-xs-12">丁雯雯</span>
							<span class="yunbi-tip-text col-xs-10">
								<span>只要花费20</span>
							<svg class="icon-yunbi" aria-hidden="true">
								<use xlink:href="#icon-yunbi"></use>
							</svg>
							<span>云币即可加聊聊，</span> 现在就加ta聊聊吗？
							</span>
						</div>
					</div>
					<div class="dialog-footer col-xs-12">
						<span class="cancel col-xs-6">取消</span>
						<span class="sure col-xs-6">确定</span>
					</div>
				</div>
			</div>
		</div>
	...
	<script>
		(function($, document) {
			...
			if(request["jump_action_id"]) {
			 ...
			 alert("看看详情--action_id="+action_id);
			} else {
				//product_id = "4";
			}
			//接口路径（看看--活动详情页/点赞，打赏，收藏过该活动的人/活动详情页关联商品/活动详情页评论）
			...
			function init_detail(datas) {
				...
				$("#page_view").text(page_view + "次");
				$("#video_duration").text("时长：" + video_duration);
			...
			function init_reply(datas, commentId, replyTotal) {
				$.each(datas.reply_info, function(index, getdata) {
					...
					//提示剩余评论数
					var remainTip = '<span class="view-other-replys col-xs-12"> 查看剩余' + remain + '条评论</span>';
					//第一条评论显示
