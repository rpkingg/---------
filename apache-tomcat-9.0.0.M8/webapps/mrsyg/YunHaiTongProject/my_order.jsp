	...
	<body class="body-sty">
		...
		<div id="panel1" class="car-container" style="margin-top: -0.2rem;">
			...
			<div class="no_order" id="no_order_one">
				...
				<div class="no_order_content" style="">暂无订单</div>
			</div>
		</div>
			...
			(function($, document) {
				...
				function init(datas, note_id, orderNum_id, no_order) {
					...
					if(datas.orderinfo) {
						...
						$("#" + no_order).hide();
						console.log("顶部tab数字orderNum=" + orderNum + ",orderNum_id=" + orderNum_id);
					}
						...
						switch(order_status) {
							case "1":
								bottom_string = '<div class="bottom-info-box add-h">' +
									'<div class="btn-close add-css order-again pay_order_btn" order-type="' + order_type + '">付款</div>' +
				...
				$(".car-container").on("click", ".cancle_order_btn", function() {
					...
					console.log("取消订单orderNum=" + orderNum);
					//接口路径
				...
				$(".car-container").on("click", ".pay_order_btn", function() {
					...
					console.log("付款orderNum=" + pay_orderNum + ",pay_orderType=" + pay_orderType);
					$("#pay-order").show();
				});
				//提醒发货
				...
				$(".car-container").on("click", ".sure_order_btn", function() {
					//订单编号
					var orderNum = $(this).parents(".order_container").attr("id");
					console.log("确认收货orderNum=" + orderNum);
				...
				$(".car-container").on("click", ".delete_order_btn", function() {
					...
					var $_this = $(this);
					var orderNum = $(this).parents(".order_container").attr("id");
					console.log("删除订单orderNum=" + orderNum);
					//$(".delete-order").show();
				...
				$(".car-container").on("click", ".evaluation_order_btn", function() {
					...
					if(product_num > 1) {
						need_title = need_title + "等" + product_num + "件商品";
					}
				...
				$(".sure-pay").on("click", function() {
					if(payType == "alipay") {
						...
						console.log("进入支付环节pay_orderType=" + pay_orderType);
						//微信支付
