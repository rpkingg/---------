...
<html lang="zh-CN">
	...
	<head>
		...
		<script type="text/javascript">
			...
			function callByNative(){
				var Persion ={
				title : $("#product_name_id").text(),	
				text : $("#selected_parameter_id").text(),	
				imageUrl : $("#pop_up_pic").attr("src"),
				url : "goods_detail.jsp?jump_product_id="+$(".goods-pics-container").attr("id")
				}
	...
	<body ontouchstart="" class="container">
		...
		<section class="goods-detail-container row text-center">
			<section class="goods-base-target col-xs-12">
				...
				<div class="goods-base-info-container col-xs-12 text-left">
                    ...
                    <span class="goods-price-new" id="product_new_price_id">0.00</span>
					<span class="goods-price-old col-xs-4" id="product_old_price_id">0.00</span>
					<!--限时购商品详情，限时剩余时间-->
					<span class="remain-time-tip col-xs-6 text-right"><span class="remain-time"></span></span>
					</span>
					<span class="goods-title col-xs-12" id="product_name_id"></span>
				...
				<div class="user-goods-select-container col-xs-12">
					<div class="user-select-params col-xs-12 text-left">
						...
						<span class="goods-label-value col-xs-9" id="selected_parameter_id"></span>
					...
					<div class="get-goods-address col-xs-12 text-left">
						...
						<span class="goods-label-value col-xs-9" id="receiver_address_id"></span>
						<span class="iconfont icon-jiantou-copy col-xs-1 text-right"></span>
					</div>
					<div class="goods-instruction col-xs-12 text-left">
						<span class="goods-label col-xs-2">说明</span>
						<span class="goods-label-value col-xs-10">正品保障 / 货到付款 / 自提 / 7天退换货 / 迪信通发货售后</span>
					</div>
				</div>
				<span class="break-line-bar col-xs-12"></span>
			</section>
			...
			<section class="goods-comment-target col-xs-12">
				<div class="goods-comment-container col-xs-12">
					<div class="goods-comment-tip-container col-xs-12 hide">
					...
					<span id="view-all-comment" class="view-all-comment view-all col-xs-4 pull-right text-right">全部<span class="iconfont icon-jiantou-copy"></span></span>
				</div>
				...
				<div class="goods-notes-container col-xs-12">
					...
					<span id="view-all-notes" class="view-all-notes view-all col-xs-4 pull-right text-right">全部<span class="iconfont icon-jiantou-copy"></span></span>
				</div>
				<div id="goods-notes-contents" class="goods-notes-contents col-xs-12">
						...
						<div class="goods-promise-container col-xs-12 text-center">
							...
							<div class="goods-promise-item col-xs-3">
								<div class="promise-icon col-xs-12">
									<span class="iconfont icon-zheng" style="padding: 1.1rem;"></span>
								</div>
								<span class="promise-title col-xs-12">正品保障</span>
							</div>
							<div class="goods-promise-item col-xs-3">
								<div class="promise-icon col-xs-12">
									<span class="iconfont icon-7tian" style="padding: 0.7rem;"></span>
								</div>
								<span class="promise-title col-xs-12">7天发货</span>
							</div>
							<div class="goods-promise-item col-xs-3">
								<div class="promise-icon col-xs-12">
									<span class="iconfont icon-wuliu" style="padding: 1rem;"></span>
								</div>
								<span class="promise-title col-xs-12">物流保障</span>
							</div>
							<div class="goods-promise-item col-xs-3">
								<div class="promise-icon col-xs-12">
									<span class="iconfont icon-baozhang" style="padding: 1rem;"></span>
								</div>
			...
			<div class="place-order-content col-xs-12">
				<div class="goods-base-info col-xs-12">
					...
					<div class="goods-info col-xs-9">
						<span class="goods-name col-xs-12"></span>
						<span class="goods-price-container col-xs-12">
                            <span class="goods-price-new"><span class="yen">￥</span><span id="pop_up_new_price">0.00</span></span>
						<span class="goods-price-old"><span class="yen">￥</span><span id="pop_up_old_price">0.00</span></span>
						</span>
					</div>
				</div>
		...
		<div class="goods-big-preview-container col-xs-12 hide">
			<div class="goods-big-preview col-xs-12 text-center">
				...
				<div class="preview-content col-xs-12">
					<div class="swiper-container">
						<div class="swiper-wrapper" id="goods-big-preview-container-id">
		...
		<div class="iframe_container" id="iframe_select_address">
			<iframe id="iframe_select_address_id" src="select_address_iframe.jsp" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
		</div>
	</body>
